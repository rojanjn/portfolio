...
const projects: Project[] = [
  {
    ...
    description:
      "A fun little 8-Ball app that answers your Yes/No questions with style.",
    image: "../assets/img/8Ball.png",
  ...
  },
  {
    ...
    image: "../assets/img/hangsman.png",
    tags: ["Python", "ASCII"],
    githubUrl:
      "https://github.com/rojanjn/python-practices/tree/main/hangsman",
  },
  {
    id: 3,
    title: "Book Collection",
    description:
      "Personalized web app for showcasing a small collection of books I love",
    image: "../assets/img/bookcollection.png",
    tags: ["Javascript", "JSON", "HTML", "Css"],
    liveUrl: "https://rojanjn.github.io/rojan-book-collection/",
    githubUrl:
      "https://github.com/rojanjn/rojan-book-collection",
  },
  {
    id: 4,
    title: "Number Guessing Game",
    description:
      "A simple Guessing game built with Python for the terminal.",
    image: "../assets/img/nguessing.png",
    tags: ["Python"],
    githubUrl:
      "https://github.com/rojanjn/python-practices/tree/main/number-guessing",
  },
  {
    id: 5,
    ...
    tags: ["Java"],
    githubUrl:
      "https://github.com/rojanjn/Java-Student-Tracker",
  },
  //     {
  //         id: 6,
  //         title: 'Strudent Tracker',
